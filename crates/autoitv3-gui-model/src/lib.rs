...
pub use model::{
    ...
    DEFAULT_DESKTOP_SIZE, GUI_CHECKED, GUI_DISABLE, GUI_ENABLE, GUI_HIDE, GUI_PAGE_HIDDEN,
    GUI_SHOW, WIN_ACTIVE, WIN_ENABLED, WIN_EXISTS, WIN_MAXIMIZED, WIN_MINIMIZED, WIN_VISIBLE,
};
